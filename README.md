...
This repository is entirely vibe-coded: all source code was generated by AI
coding agents from human prompts, with no human-written code. The prompts and
development conversation can be inspected in [`chat.md`](chat.md).
